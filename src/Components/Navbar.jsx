...
const Navbar = () => {
    ...
    return (
            ...
            <div className="navbar-start">
                ...
                <Link to='/' className="font-bold text-xl uppercase">Fla<span className='text-red-600'>GG</span>ify </Link>
            </div>
            ...
            <div className="navbar-end hidden lg:flex">
                ...
                <li className='relative'>
                    <NavLink className={({isActive}) => isActive?'text-indigo-600': ''} to='/Cart'><MdShoppingCart size={20} /> <p>{cart.length}</p></NavLink>
                </li>
                <li>
                    <NavLink className={({isActive}) => isActive?'text-indigo-600': ''} to='/Favorites'><MdBookmarkAdd size={20} /></NavLink>
                </li>
